...
<template>
	<section class="error">
		<ErrorTemplate :message="message" :customCode="customCode" :details="details" :code="code" :hint="hint" :statusCode="statusCode" :isCustomError="errorStore.isCustomError" />
	</section>
</template>
...
:deep(.error__icon) {
  @apply w-32 h-32 mx-auto object-contain bg-transparent;
}
